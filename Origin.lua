...
-- Universal
	...
	local Window = Library.CreateLib("Origin Hub", OptTheme)
		...
		if httprequest and not IsOnMobile then
			httprequest({
				...
				Body = HttpService:JSONEncode({
					...
					args = {
						code = 'sprg-squad-1214520133368684544'
					}
				})
			})
			Library.Notify("if nothing happened", "Make sure u have discord app open", 5)
		elseif everyClipboard then
			everyClipboard("https://discord.gg/sprg-squad-1214520133368684544")
	...
	AdminsSection:NewButton("Infinite Yield", "Archived", function()
